...
const Sweet = () => {
  return (
    <div name="sweet" className='w-full min-h-screen flex items-center justify-center'>
      <div name='sweet-res' className='max-w-[1400px] m-auto px-4 grid lg:grid-cols-2 gap-4 sm:pt-0 sm:pb-0'>
        <div className='flex flex-col h-full justify-center'>
          ...
          <p className='text-xl text-justify pb-6 mt-2 max-sm:order-2 sm:order-2 sm:pb-1'>Máte rádi sladké? U nás si určitě vyberete. Koláčky a zákusky jsou 100% domácí a dělané s láskou. 
          </p>
        </div>
